...
class Musica:
    ...
    def __init__(self, nome, categoria, autor):
        ...
        self.nome = nome.title() # Indica titulo da Musica
        self.categoria = categoria.upper() # Indica categoria da Musica
        self.autor = autor # Indica nome do Autor
        self.online = False  # Indica se a música está online ou não.
...
#def str para reconhecer mais um metódo próprio Python  
    ...
    def list_music():
        ...
        for music in Musica.musics:
            print(f'{music.nome.ljust(25)} | {music.categoria.ljust(25)} | {music.autor.ljust(25)}')
